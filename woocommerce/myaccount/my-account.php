...
// Avatar: use meta or gravatar fallback
$avatar_url  = get_avatar_url( $current_user->ID, array( 'size' => 290 ) );
...
<section class="gk-accdash">
	...
	<div class="gk-accdash__outer">
		...
		<div class="gk-accdash__hero">
			<div class="gk-accdash__heroTopLeft">
				<div class="gk-accdash__heroAvatarSmall" aria-hidden="true">
					<?php if ( $avatar_url ) : ?>
						<img class="gk-accdash__heroAvatarImg" src="<?php echo esc_url( $avatar_url ); ?>" alt="" width="32" height="32">
					<?php else : ?>
			...
			<div class="gk-accdash__heroCenter">
				<div class="gk-accdash__heroAvatar" aria-hidden="true">
					<?php if ( $avatar_url ) : ?>
						<img class="gk-accdash__heroAvatarImg" src="<?php echo esc_url( $avatar_url ); ?>" alt="" width="145" height="145">
					<?php else : ?>
						<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
							<path d="M12 12c2.761 0 5-2.239 5-5S14.761 2 12 2 7 4.239 7 7s2.239 5 5 5Z"/>
							<path d="M4 22c0-4.418 3.582-8 8-8s8 3.582 8 8"/>
		...
		<?php
		/* REMOVED LAYOUT – für später wiederherstellen, siehe: assets/css/account-dashboard-removed-layout.md */
		?>
	</div>
</section>
