			...
			<div class="gk-register-block" id="gk-register-block">
				<div class="gk-login-box">
					...
					<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
						...
						<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="reg_email" autocomplete="email" placeholder="globalkeys@games.co" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>" required aria-required="true" /><?php // phpcs:ignore WordPress.Security.NonceVerification.Missing ?>
					</p>
						...
						<p class="form-row gk-login-submit-row">
							...
							<button type="submit" class="woocommerce-Button woocommerce-button button gk-btn-login woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Registrieren', 'woocommerce' ); ?>" disabled><?php esc_html_e( 'Registrieren', 'globalkeys' ); ?></button>
						</p>
